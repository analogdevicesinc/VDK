...
remote processor (via the Internal Memory DMA) and automatically frees the block
in the local memory pool. The pool marshalling function on the remote processor
