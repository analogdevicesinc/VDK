...
#   $RCSfile$
#
#   Description: Makefile for compiling the BF534
#
#   Last modified $Date$
...
ASM           = EASMBLKFN
ASMFLAGS      = -proc ADSP-BF534 ${UP_ASMFLAGS}
CXX           = ${UP_CXX}
CXXFLAGS      = -proc ADSP-BF534 ${UP_CXXFLAGS} ${INCLUDE_PATH} 
...
DEFINES               = ${UP_DEFINES} -DVERSION_PRODUCT_="VDK::kBF534"
endif
...
ifeq (${ADI_MAKE}, 1)
INCLUDE_PATH= -I '$(shell cygpath -w ${TOP_DIR}/blackfin/2153X/BF534)' ${UP_INCLUDE_PATH}
else
...
ifeq (${REVISION},all)
build_BF534: build_BF534_0_0 build_BF534_0_3 build_BF534_any
clean: clean_current_dir clean_BF534_0_0 clean_BF534_0_3 clean_BF534_any
install: install_examples install_BF534_0_0 install_BF534_0_3 install_BF534_any
install_debug: install_examples install_debug_BF534_0_0 install_debug_BF534_0_3 install_debug_BF534_any
else
ifeq (${REVISION},0.0)
build_BF534: build_BF534_0_0 
clean: clean_current_dir clean_BF534_0_0 
install: install_examples install_BF534_0_0 
install_debug: install_examples install_debug_BF534_0_0 
else
ifeq (${REVISION},0.3)
build_BF534: build_BF534_0_3 
clean: clean_current_dir clean_BF534_0_3 
install: install_examples install_BF534_0_3 
install_debug: install_examples install_debug_BF534_0_3 
else
ifeq (${REVISION},any)
build_BF534: build_BF534_any 
clean: clean_current_dir clean_BF534_any 
install: install_examples install_BF534_any 
install_debug: install_examples install_debug_BF534_any 
else
build_BF534: build_BF534_0_0 build_BF534_0_3 build_BF534_any
clean: clean_current_dir clean_BF534_0_0 clean_BF534_0_3 clean_BF534_any
install: install_examples install_BF534_0_0 install_BF534_0_3 install_BF534_any
...
build_BF534_0_0:
	${MKDIR} bf534_rev_0.0
	"${MAKE}" -f../makefile.mk  -C bf534_rev_0.0 build_libs ${NEW_FLAGS} VEROPTIONS="-si-revision 0.0" UP_CXXFLAGS+="-si-revision 0.0 " UP_ASMFLAGS+="-si-revision 0.0" NESTED_MAKE="YES"


clean_BF534_0_0:
	${MKDIR} bf534_rev_0.0
	"${MAKE}" -f../makefile.mk  -C bf534_rev_0.0 clean_libs  NESTED_MAKE="YES"

install_BF534_0_0:
	"${MAKE}" -i -fmakefile.mk  install_libs ${NEW_FLAGS} SI_REV="bf534_rev_0.0" INST_DIR="bf534_rev_0.0"

install_debug_BF534_0_0:
	"${MAKE}" -i -fmakefile.mk  install_debug_libs ${NEW_FLAGS} SI_REV="bf534_rev_0.0" INST_DIR="bf534_rev_0.0"

build_BF534_0_3:
	${MKDIR} bf534_rev_0.3
	"${MAKE}" -f../makefile.mk  -C bf534_rev_0.3 build_libs ${NEW_FLAGS} VEROPTIONS="-si-revision 0.3" UP_CXXFLAGS+="-si-revision 0.3 " UP_ASMFLAGS+="-si-revision 0.3" NESTED_MAKE="YES"


clean_BF534_0_3:
	${MKDIR} bf534_rev_0.3
	"${MAKE}" -f../makefile.mk  -C bf534_rev_0.3 clean_libs  NESTED_MAKE="YES"

install_BF534_0_3:
	"${MAKE}" -i -fmakefile.mk  install_libs ${NEW_FLAGS} SI_REV="bf534_rev_0.3" INST_DIR="bf534_rev_0.3"

install_debug_BF534_0_3:
	"${MAKE}" -i -fmakefile.mk  install_debug_libs ${NEW_FLAGS} SI_REV="bf534_rev_0.3" INST_DIR="bf534_rev_0.3"

# any libs
build_BF534_any:
	${MKDIR} bf534_rev_any
	"${MAKE}" -f../makefile.mk  -C bf534_rev_any build_libs ${NEW_FLAGS} VEROPTIONS="-si-revision any" UP_CXXFLAGS+="-si-revision any " UP_ASMFLAGS+="-si-revision any" NESTED_MAKE="YES"


clean_BF534_any:
	${MKDIR} bf534_rev_any
	"${MAKE}" -f../makefile.mk  -C bf534_rev_any clean_libs  NESTED_MAKE="YES"

install_BF534_any:
	"${MAKE}" -i -fmakefile.mk  install_libs ${NEW_FLAGS} SI_REV="bf534_rev_any" INST_DIR="bf534_rev_any"

install_debug_BF534_any:
	"${MAKE}" -i -fmakefile.mk  install_debug_libs ${NEW_FLAGS} SI_REV="bf534_rev_any" INST_DIR="bf534_rev_any"
...
ADSP-BF534.ini:FORCE
	...
	${DOS_ENDL}						>> $@
	${ECHO} "LinkerFile = $(QUOTE)blackfin\ldf\VDK-BF534.ldf$(QUOTE)"	>> $@
	${DOS_ENDL}						>> $@
	${ECHO} "Interrupts = $(QUOTE)$(CORE_INAMES)$(QUOTE)" >>$@
	${DOS_ENDL}						>> $@
	${ECHO} "ExceptionHandler = ExceptionHandler-BF534.asm" >>$@
	${DOS_ENDL}						>> $@
	...
	${DOS_ENDL}						>> $@
	${ECHO} "AsmIsrCodeTemplate = BF534_ISR_Asm_Source.asm"	>> $@
	${DOS_ENDL}						>> $@
...
install_examples: ADSP-BF534.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/ldf
	${CP} VDK-BF534.ldf ${INSTALL_DIR}/ldf
	${CP} ADSP-BF534.ini ${INSTALL_DIR}/vdk
...
dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-BF534.ldf
