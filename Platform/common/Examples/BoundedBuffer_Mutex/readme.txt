Project Name: BoundedBuffer_Mutex
Project Type: VDK
Hardware Used: None Required

Overview
--------
This example demonstrates how a shared circular buffer that is
accessed by an unspecified number of threads can be protected 
using two semaphores and a mutex object.

The solution provided ensures that the data stored in the buffer 
is not overwritten until it has first been consumed.
