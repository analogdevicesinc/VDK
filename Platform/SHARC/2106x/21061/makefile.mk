...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21061
#
#   Last modified $Date$
...
ADSP-21061.ini: FORCE
	...
	${DOS_ENDL}                                             >> $@
	${ECHO} "LinkerFile = $(QUOTE)21k\ldf\VDK-21061.ldf$(QUOTE)"               >> $@
	${DOS_ENDL}                                             >> $@
...
install_debug: ADSP-21061.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/ldf
	${CP} VDK-21061.ldf ${INSTALL_DIR}/ldf
	${CP} ADSP-21061.ini ${INSTALL_DIR}/vdk

install:install_debug

dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-21061.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21061.ini
