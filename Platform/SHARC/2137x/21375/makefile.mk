...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21375
#
#   Last modified $Date$
...
QUOTE		= \"
DOS_ENDL   = @cmd /c echo.
CORE_VECS       = $(shell ${TYPE} ../../2137x/21371/IntVectors.dat)
CORE_VECS2       = $(shell ${TYPE} ../../2137x/21371/IntVectors2.dat)
...
ADSP-21375.ini:FORCE
	...
	${DOS_ENDL}	                                     >> $@
	${ECHO} "LinkerFile = $(QUOTE)213xx\ldf\VDK-21375.ldf$(QUOTE)"	       >> $@
	${DOS_ENDL}	                                     >> $@
...
install_debug: ADSP-21375.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/../213xx/ldf
	${MKDIR} ${INSTALL_DIR}/lib
	${CP} VDK-21375.ldf ${INSTALL_DIR}/../213xx/ldf
	${CP} ADSP-21375.ini ${INSTALL_DIR}/../213xx/vdk

install: install_debug

dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-21375.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21375.ini
