...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21363
#
#   Last modified $Date$
...
ADSP-21363.ini: FORCE
	...
	${DOS_ENDL}	                                     >> $@
	${ECHO} "LinkerFile = $(QUOTE)213xx\ldf\VDK-21363.ldf$(QUOTE)"	       >> $@
	${DOS_ENDL}	                                     >> $@
...
install_debug: ADSP-21363.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/../213xx/ldf
	${MKDIR} ${INSTALL_DIR}/lib
	${CP} VDK-21363.ldf ${INSTALL_DIR}/../213xx/ldf
	${CP} ADSP-21363.ini ${INSTALL_DIR}/../213xx/vdk

install: install_debug

dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-21363.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21363.ini
