...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21367
#
#   Last modified $Date$
...
QUOTE		= \"
DOS_ENDL   = @cmd /c echo.
CORE_VECS       = $(shell ${TYPE} ../21369/IntVectors.dat)
CORE_VECS2       = $(shell ${TYPE} ../21369/IntVectors2.dat)
...
ADSP-21367.ini: FORCE
	...
	${DOS_ENDL}	                                     >> $@
	${ECHO} "LinkerFile = $(QUOTE)213xx\ldf\VDK-21367.ldf$(QUOTE)"	       >> $@
	${DOS_ENDL}	                                     >> $@
...
install_debug: ADSP-21367.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/../213xx/ldf
	${MKDIR} ${INSTALL_DIR}/lib
	${CP} VDK-21367.ldf ${INSTALL_DIR}/../213xx/ldf
	${CP} ADSP-21367.ini ${INSTALL_DIR}/../213xx/vdk

install: install_debug

dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-21367.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21367.ini
