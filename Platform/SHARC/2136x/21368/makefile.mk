...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21368
#
#   Last modified $Date$
...
ADSP-21368.ini: FORCE
	...
	${DOS_ENDL}	                                     >> $@
	${ECHO} "LinkerFile = $(QUOTE)213xx\ldf\VDK-21368.ldf$(QUOTE)"	       >> $@
	${DOS_ENDL}	                                     >> $@
...
install_debug: ADSP-21368.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/../213xx/ldf
	${MKDIR} ${INSTALL_DIR}/lib
	${CP} VDK-21368.ldf ${INSTALL_DIR}/../213xx/ldf
	${CP} ADSP-21368.ini ${INSTALL_DIR}/../213xx/vdk

install: install_debug

dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-21368.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21368.ini
