...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21475
#
#   Last modified $Date$
...
ADSP-21475.ini:FORCE
	...
	${DOS_ENDL}	                                     >> $@
	${ECHO} "LinkerFile = $(QUOTE)214xx\ldf\VDK-21475.ldf$(QUOTE)"	       >> $@
	${DOS_ENDL}	                                     >> $@
...
install_debug: ADSP-21475.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/../214xx/ldf
	${MKDIR} ${INSTALL_DIR}/lib
	${CP} VDK-21475.ldf ${INSTALL_DIR}/../214xx/ldf
	${CP} ADSP-21475.ini ${INSTALL_DIR}/../214xx/vdk

install: install_debug

dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-21475.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21475.ini
