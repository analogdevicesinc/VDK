...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21262
#
#   Last modified $Date$
...
ASMFLAGS	= -proc ADSP-21262 ${UP_ASMFLAGS}
else
ASMFLAGS	= -proc ADSP-21262 ${UP_ASMFLAGS} -file-attr ADI_OS=VDK -file-attr prefersMem=internal -file-attr prefersMemNum=30 -double-size-any -Wwarn-error
endif
endif
CXX			= ${UP_CXX} 
CXXFLAGS	= -proc ADSP-21262 ${UP_CXXFLAGS} -double-size-any
...
CORE_IRQNAME= $(shell ${TYPE} IntIRQs.dat)
CORE_NOIRQNAME  = $(shell ${TYPE} IntNoIRQs.dat)
DEFINES		= ${UP_DEFINES} -D VERSION_PRODUCT_="VDK::k21262" -DVDK_INT_=INT_INT14_P
endif
...
OUTPUT		= ${OUT_DIR}21262.dlb

ifeq (${ADI_MAKE}, 1)
INCLUDE_PATH= -I '$(shell cygpath -w ${TOP_DIR}/2126x/21262)' ${UP_INCLUDE_PATH}
else
...
VDKGEN_FLAGS = -proc ADSP-21262 ++vdkgen_for_rt ++VDSP_4.5 ++install_dir '$(shell cygpath -w ${INSTALL_DIR}/..)'
else
ifeq (${VDSP_VERSION},4.5)
VDKGEN_FLAGS = -proc ADSP-21262 ++vdkgen_for_rt ++VDSP_4.5 ++install_dir '$(shell cygpath -w ${INSTALL_DIR}/..)'
else
VDKGEN_FLAGS = -proc ADSP-21262 ++vdkgen_for_rt ++VDSP_4.0 ++install_dir '$(shell cygpath -w ${INSTALL_DIR}/..)'
endif
endif
...
CORE_OUTPUT	= ./debug/VDK-CORE-21262.dlb
INSTALL_TYPE= debug
else
CORE_OUTPUT	= ./release/VDK-CORE-21262.dlb
...
all:		default
default: build_21262
build_21262_libs:$(CORE_OUTPUT)
install:install_libs install_examples
install_debug:install_debug_libs install_examples
squeaky: squeaky_current_dir clean

ifeq (${REVISION},all)
build_21262: asm_file_generation build_21262_0_1 build_21262_any build_21262_none
clean: clean_current_dir clean_21262_0_1 clean_21262_any clean_21262_none
install_libs: install_21262_0_1 install_21262_any install_21262_none
install_debug_libs: install_debug_21262_0_1 install_debug_21262_any install_debug_21262_none
else
ifeq (${REVISION},0.0)
build_21262: asm_file_generation build_21262_0_1
clean: clean_current_dir clean_21262_0_1
install_libs: install_21262_0_1
install_debug_libs: install_debug_21262_0_1
else
ifeq (${REVISION},none)
build_21262: asm_file_generation build_21262_none
clean: clean_current_dir clean_21262_none
install_libs: install_21262_none
install_debug_libs: install_debug_21262_none
else
ifeq (${REVISION},any)
build_21262: asm_file_generation build_21262_any
clean: clean_current_dir clean_21262_any
install_libs: install_21262_any
install_debug_libs: install_debug_21262_any
else
build_21262: asm_file_generation build_21262_0_1 build_21262_any build_21262_none
clean: clean_current_dir clean_21262_0_1 clean_21262_any clean_21262_none
install_libs: install_21262_0_1 install_21262_any install_21262_none
...
build_21262_0_1: 
	${MKDIR} 2126x_rev_0.0 
	"${MAKE}" -f../makefile.mk  -C 2126x_rev_0.0 build_21262_libs ${NEW_FLAGS} VEROPTIONS="-si-revision 0.1" UP_CXXFLAGS+="-si-revision 0.1 " UP_ASMFLAGS+="-si-revision 0.1" NESTED_MAKE="YES" 

clean_21262_0_1:
	${MKDIR} 2126x_rev_0.0
	"${MAKE}" -f../makefile.mk  -C 2126x_rev_0.0 clean_21262_libs ${NEW_FLAGS} NESTED_MAKE=YES


install_21262_0_1: 
	"${MAKE}" -i -fmakefile.mk  install_21262_libs ${NEW_FLAGS} SI_REV="2126x_rev_0.0" INST_DIR="2126x_rev_0.0" 

install_debug_21262_0_1: 
	"${MAKE}" -i -fmakefile.mk  install_debug_21262_libs ${NEW_FLAGS} SI_REV="2126x_rev_0.0" INST_DIR="2126x_rev_0.0" 

##############################
# Fastest libraries with no workarounds
build_21262_none: 
	${MKDIR} 2126x_rev_none
	"${MAKE}" -f../makefile.mk  -C 2126x_rev_none build_21262_libs ${NEW_FLAGS} VEROPTIONS="-si-revision none" UP_CXXFLAGS+="-si-revision none" UP_ASMFLAGS+="-si-revision none" NESTED_MAKE="YES"

clean_21262_none:
	${MKDIR} 2126x_rev_none
	"${MAKE}" -f../makefile.mk  -C 2126x_rev_none clean_21262_libs ${NEW_FLAGS} UP_CXXFLAGS+="-si-revision none" UP_ASMFLAGS+="-si-revision none" NESTED_MAKE=YES

install_21262_none: 
	"${MAKE}" -i -fmakefile.mk  install_21262_libs ${NEW_FLAGS} SI_REV="2126x_rev_none" INST_DIR="" 

install__debug_21262_none: 
	"${MAKE}" -i -fmakefile.mk  install_debug_21262_libs ${NEW_FLAGS} SI_REV="2126x_rev_none" INST_DIR="" 

##############################
# Valid for any silicon. All the workarounds in the world
build_21262_any: 
	${MKDIR} 2126x_rev_any
	"${MAKE}" -f../makefile.mk  -C 2126x_rev_any build_21262_libs ${NEW_FLAGS} VEROPTIONS="-si-revision any" UP_CXXFLAGS+="-si-revision any" UP_ASMFLAGS+="-si-revision any" NESTED_MAKE="YES"

clean_21262_any:
	${MKDIR} 2126x_rev_any
	"${MAKE}" -f../makefile.mk  -C 2126x_rev_any clean_21262_libs ${NEW_FLAGS} NESTED_MAKE=YES

install_21262_any: 
	"${MAKE}" -i -fmakefile.mk  install_21262_libs ${NEW_FLAGS} SI_REV="2126x_rev_any" INST_DIR="2126x_any" 

install_debug_21262_any: 
	"${MAKE}" -i -fmakefile.mk  install_debug_21262_libs ${NEW_FLAGS} SI_REV="2126x_rev_any" INST_DIR="2126x_any" 
...
ADSP-21262.ini: FORCE
	...
	${DOS_ENDL}	                                     >> $@
	${ECHO} "LinkerFile = $(QUOTE)212xx\ldf\VDK-21262.ldf$(QUOTE)"	       >> $@
	${DOS_ENDL}	                                     >> $@
...
squeaky_current_dir:
	...
	${foreach example_dir,${EXAMPLES_LIST}, rm ${example_dir}/VDK-21262.ldf; }
...
install_examples: ADSP-21262.ini ${VDKGEN}
	"${MAKE}" -fmakefile.mk -C../../../Utilities/VdkGen
	${MKDIR} ${INSTALL_DIR}/../212xx/ldf
	${MKDIR} ${INSTALL_DIR}/vdk
	${CP} VDK-21262.ldf ${INSTALL_DIR}/../212xx/ldf
	${CP} ADSP-21262.ini ${INSTALL_DIR}/../212xx/vdk
	${CP} ${VDKGEN} ${INSTALL_DIR}/vdk
	@echo "**************Creating LDF Vdk.cpp and Vdk.h files for examples ***********"
	@echo ""
	${foreach example_dir,${EXAMPLES_LIST}, cp VDK-21262.ldf ${example_dir}; }
	${foreach the_kernel_file,${VDK_FILES_LIST}, ${INSTALL_DIR}/vdk/Vdkgen.exe ${VDKGEN_FLAGS} '$(shell cygpath -w ${CURR_DIR}/${the_kernel_file})'; }
	${RM} ${EXAMPLES_DIR}/MultipleHeaps/VDK-21262.ldf
	${foreach example_dir,${EXAMPLES_LIST}, ${RM} ${example_dir}/*.rbld; }
	@echo "**************LDF Vdk.cpp and Vdk.h for examples created ***********"
	"${MAKE}" -i -f../../../../common/examples/makefile.mk -C${EXAMPLES_DIR} UP_EXAMPLES_INSTALL_DIR=${INSTALL_DIR}/Examples/"No\ Hardware\ Required"/VDK/21262 install

install_debug_21262_libs: 
	${MKDIR} ${INSTALL_DIR}/lib/${INST_DIR}
	${CP} ${SI_REV}/debug/VDK-*-21262.dlb ${INSTALL_DIR}/lib/${INST_DIR}

install_21262_libs:install_debug_21262_libs
	${CP} ${SI_REV}/release/VDK-*-21262.dlb ${INSTALL_DIR}/lib/${INST_DIR}

dist_clean:
	"${MAKE}" -i -f../../../../common/examples/makefile.mk -C${EXAMPLES_DIR} UP_EXAMPLES_INSTALL_DIR=${INSTALL_DIR}/Examples/"No\ Hardware\ Required"/VDK/21262 dist_clean
	${RM} ${INSTALL_DIR}/ldf/VDK-21262.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21262.ini
	${RM} ${INSTALL_DIR}/lib/VDK-*-21262.dlb
	${RMDIR} debug
	${RMDIR} release
	${MKDIR} debug
	${MKDIR} release
