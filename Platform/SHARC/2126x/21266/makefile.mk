...
#   $RCSfile$
#
#   Description: Makefile for compiling the 21266
#
#   Last modified $Date$
...
QUOTE		= \"
DOS_ENDL   = @cmd /c echo.
CORE_VECS       = $(shell ${TYPE} ../21262/IntVectors.dat)
CORE_VECS2       = $(shell ${TYPE} ../21262/IntVectors2.dat)
TMR_INTERRUPTS	= $(shell ${TYPE} ../21262/TimerInt.dat)
...
ADSP-21266.ini:FORCE
	...
	${DOS_ENDL}	                                     >> $@
	${ECHO} "LinkerFile = $(QUOTE)212xx\ldf\VDK-21266.ldf$(QUOTE)"	       >> $@
	${DOS_ENDL}	                                     >> $@
...
install_debug: ADSP-21266.ini 
	${MKDIR} ${INSTALL_DIR}/vdk
	${MKDIR} ${INSTALL_DIR}/../212xx/ldf
	${MKDIR} ${INSTALL_DIR}/lib
	${CP} VDK-21266.ldf ${INSTALL_DIR}/../212xx/ldf
	${CP} ADSP-21266.ini ${INSTALL_DIR}/../212xx/vdk

install:install_debug

dist_clean:
	${RM} ${INSTALL_DIR}/ldf/VDK-21266.ldf
	${RM} ${INSTALL_DIR}/vdk/ADSP-21266.ini
